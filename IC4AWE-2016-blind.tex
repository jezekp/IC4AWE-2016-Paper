...
\author{\authorname{Omitted for a review process\sup{1} and Omitted for a review process\sup{1}}
\affiliation{\sup{1}Omitted for a review process,
              Omitted for a review process,
              Omitted for a review process,
              Omitted for a review process,
              Omitted for a review process,
              Omitted for a review process,
              Omitted for a review process}
\email{Omitted for a review process, Omitted for a review process}
}
