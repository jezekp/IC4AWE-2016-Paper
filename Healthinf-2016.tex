...
\abstract{There are lot of sensors for monitoring human health or fitness level on the market. Sensors enable collection of data from human body and their visualisation to the user. Advanced devices also enable transfer of data to remote servers where they are processed. These sensors uses different topology for data transter, transfered data are implemented in different formats. It make them difficult to be integrated with similar neuroinformatics databases raising within the community. As a solution a terminology describing limited collection of sensor data is presented. This terminology si implemented  in the odML format and integrated in a proof-of-concept Android application. This application enables collectio of data from a restricted set of sensors. The data transfer on a remote server EEGBase and its visulaisation is also presented.}
