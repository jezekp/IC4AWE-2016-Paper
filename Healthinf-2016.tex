...
\abstract{There are lot of sensors for monitoring of human health or a fitness level on the market. Sensors enable collection of data from human body and their visualization to the user. Advanced devices also enable transfer of data to remote servers where they are processed. These sensors use different topology for data transfer plus transfered data are implemented in different formats. It make them difficult to be integrated with similar neuroinformatics databases raising within the community. As a solution a terminology describing a limited collection of sensors' data is presented. This terminology si implemented  in the odML format and integrated in a proof-of-concept Android application. This application enables collection of data from a restricted set of sensors. The data transfer on a remote server EEGBase and their visualization is also presented.}
...
Moreower, neuroinformatics community identified problems with a long-term description, storage and management of experimental data/metadata \cite{CRCNS}.Ontology for Experimental Neurophysiology (OEN) \cite{10.3389/conf.fninf.2014.18.00044} is a semantic web approach to describe terminology used in biomedical and neuro sciences. As a member of International Neuroinformatics Coordinating Facility (INCF) \cite{INCF} we are being developing a system for long term storage and management of EEG/ERP experiments - EEGBase \cite{ISI:000306821100004}. A mobile EEG-Base client \cite{10.3389/conf.fninf.2013.09.00046} is a supplementary tool that enables collecting experiments out of the laboratory and provides an on-line synchronization with EEGBase.
