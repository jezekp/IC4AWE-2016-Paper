...
\noindent
We operate a complete equipped laboratory \cite{10.3389/fninf.2014.00020} for measurement of electrophysiological activity of human body. We are focused mainly on Electroencephalography (EEG) and Event-related potentials (ERP). Except of the fixed equipment we have also so-called mobile laboratory including set of laptops and portable measuring devices enabling performing experiments out of the laboratory. When neuroinformatics community identified problems with long-term description, storage and management of experimental data/metadata we are being developing a system for long term storage and management of EEG/ERP experiments - EEGBase. A mobile EEG-Base client is a supplementary Android tool that enables collecting experiments out of the laboratory and provides an online synchronization with EEGBase.
...
{\small
\bibliography{citations-healthinf-2016,frontiers}}
